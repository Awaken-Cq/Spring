...
<body>
<%-- <c:set var="memberDetailDto" scope="${requestScope.getAttribute('memberDetailDto'}"></c:set> --%>
			...
			<!--  //일반인은 안보이지만 개발자가 넘겨야하는 정보가 있을경우 -->
				...
				<div class="form-group" align="left">
					<label for="name">이름</label> <input type="text"
						class="form-control" id="name" name="name" placeholder="${memberDetailDto.name}">
				</div>
				<div class="form-group" align="left">
					<label for="">아이디</label> <input type="text" class="form-control"
						id="id" name="id" onkeyup="" placeholder="${memberDetailDto.id}">
						<div id="idresult"> 
						</div>
				</div>
				<div class="form-group" align="left">
				...
				<div class="form-group" align="left">
					...
					<div id="email" class="custom-control-inline">
						<input type="text" class="form-control" id="emailid"
							name="emailid" placeholder="${memberDetailDto.emailid}" size="25"> @ <select
							class="form-control" id="emaildomain" name="emaildomain">							
							<option value="${memberDetailDto.emaildomain}">${memberDetailDto.emaildomain}</option>
				...
				<div class="form-group" align="left">
					...
					<div id="tel" class="custom-control-inline">
						<select class="form-control" id="tel1" name="tel1">
							<option value="${memberDetailDto.tel1}">${memberDetailDto.tel1}</option>
							...
							placeholder="${memberDetailDto.tel2}"> _ <input type="text"
							class="form-control" id="tel3" name="tel3" placeholder="${memberDetailDto.tel3}">
					</div>
				</div>
				<div class="form-group" align="left">
				...
				<div class="form-group" align="center">
					<button type="button" class="btn btn-primary" id="registerBtn"
						onclick="javascript:register();">수정</button>
