...
<c:if test="${errorMsg != null }">
	<script>
		alert("${errorMsg}");
		documnet.location.href = "${root}/index.jsp";
	</script>
</c:if>
<script>
...
<table width="100%" cellpadding="6" cellspacing="2" border="0"
	...
	<tr>
		...
		<div align="center">
			<img src="${root}/img/board/b_wirtecf.gif" id="viewBtn"
			width="91" height="21"	border="0" align="absmiddle" alt="작성한 글 확인" hspace="10">
